...
function startAutoRotateDelay() {
  controls.autoRotate = false;
  clearTimeout(autoRotateTimer);
  autoRotateTimer = setTimeout(() => { controls.autoRotate = true; }, 2000);
}
controls.domElement.addEventListener('pointerdown', startAutoRotateDelay);
controls.domElement.addEventListener('wheel', startAutoRotateDelay);
